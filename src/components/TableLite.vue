        ...
        <div class="card-body">
            ...
            <form @submit.prevent="searchFormSubmited" class="row search-form">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="search-by" v-model="searchTerm"
                            placeholder="Keyword">
                    </div>
                    <div class="col-sm-2">
            ...
            <div id="dataTables-example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="table-responsive">
                            <table class="vtl-table table table-striped striped table-hover" id="dataTables-example"
                                ref="localTable">
                                <thead class="vtl-thead thead-dark">
                                    <tr class="vtl-thead-tr">
                                        <th v-if="hasCheckbox" class="vtl-thead-th checkbox-th">
                                            <div>
                                                <input type="checkbox" class="vtl-thead-checkbox"
                                        ...
                                        <th v-for="(col, index) in columns" class="vtl-thead-th" :key="index"
                                            ...
                                            }" @click="col.sortable ? doSort(col.field) : false">{{ col.label }}</div>
                                        </th>
                                    </tr>
                                </thead>
                    ...
                    <template v-if="!setting.isHidePaging">
                        ...
                        <div class="vtl-paging-change-div col-sm-12 col-md-4">
                            ...
                            <select class="vtl-paging-count-dropdown" v-model="setting.pageSize">
                                <option v-for="pageOption in pageOptions" :value="pageOption.value"
                                    :key="pageOption.value">{{ pageOption.text }}</option>
                            </select>
                            <span class="vtl-paging-page-label">{{ messages.gotoPageLabel }}</span>
                            <select class="vtl-paging-page-dropdown" v-model="setting.page">
                                <option v-for="n in setting.maxPage" :key="n" :value="parseInt(n)">{{ n }}</option>
                            </select>
                        </div>
                ...
                <div class="row" v-else>
                    <div class="vtl-empty-msg col-sm-12 text-center">{{ messages.noDataAvailable }}</div>
                </div>
            </div>
        </div>
    </div>
